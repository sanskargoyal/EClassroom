...
$end_duration = mysqli_real_escape_string($conn, $_POST['end_duration']);
...
$sql = "INSERT INTO tbl_examinations (exam_id, category, subject, exam_name, date, end_date, duration, end_duration, passmark, re_exam, terms)
VALUES ('$exam_id', '$category', '$subject', '$exam', '$start_date', '$end_date', '$duration', '$end_duration', '$passmark', '$attempts', '$terms')";
