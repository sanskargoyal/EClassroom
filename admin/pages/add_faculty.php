...
$student_id = 'F'.get_rand_numbers(3).'-'.get_rand_numbers(3).'-'.get_rand_numbers(3).'';
...
VALUES ('$student_id', '$fname', '$lname', '$gender', '$dob', '$address', '$email', '$phone', '$department', '$category', 'faculty')";

if ($conn->query($sql) === TRUE) {
  header("location:../faculty.php?rp=6310");
} else {
  header("location:../faculty.php?rp=9157");
}
