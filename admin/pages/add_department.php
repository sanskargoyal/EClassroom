...
$department_description = ucwords(mysqli_real_escape_string($conn, $_POST['description']));
...
$sql = "INSERT INTO tbl_departments (department_id, name, description, date_registered)
VALUES ('$department_id', '$department_name', '$department_description', '$date_registered')";
