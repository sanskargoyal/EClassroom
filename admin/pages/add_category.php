...
$category_description =   ucwords(mysqli_real_escape_string($conn, $_POST['description']));
...
$sql = "INSERT INTO tbl_categories (category_id, name, department, description, date_registered)
VALUES ('$category_id', '$category_name', '$department_name', '$category_description', '$date_registered')";
